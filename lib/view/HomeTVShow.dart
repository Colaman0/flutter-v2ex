...
/// 热门综艺
class HomeTVShow extends StatefulWidget {
  @override
  _HomeTVShowState createState() => _HomeTVShowState();
}

class _HomeTVShowState extends State<HomeTVShow>
    with AutomaticKeepAliveClientMixin {
  var isEnd = false;
  var isLoading = true;
  var isLoadmore = false;
  var page = 0;
  List<HotZongyiSubjectCollectionItem> items = List();
  ...
  Widget getItem(HotZongyiSubjectCollectionItem item) {
  ...
  getData() async {
    return Api.getInstance().getTVShow(page, 30).then((Response response) {
      isLoading = false;
      HotZongyiEntity entity = HotZongyiEntity.fromJson(response.data);
...
class TVShowItemWidget extends StatefulWidget {
  HotZongyiSubjectCollectionItem subjectCollectionItem;
...
class _TVShowItemWidgetState extends State<TVShowItemWidget> {
  HotZongyiSubjectCollectionItem itemEntity;
